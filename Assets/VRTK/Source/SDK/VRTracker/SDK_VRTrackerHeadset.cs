...
namespace VRTK
{
...
#endif
    {
        ...
        private VRTracker.Manager.VRT_Tag vrtrackerTagHead;
...
public override void ProcessUpdate(Dictionary<string, object> options)
        {
            ...
            {
                GetHeadset().transform.position = vrtrackerTagHead.trackedEndpoints[0].transform.position;
                GetHeadset().transform.rotation = vrtrackerTagHead.trackedEndpoints[0].transform.rotation;
            }
        }
        ...
        public override Transform GetHeadset()
        {
            ...
            if (vrtrackerTagHead == null)
            {
                ...
                {
                    vrtrackerTagHead = VRTracker.Manager.VRT_Manager.Instance.GetHeadsetTag();
                }
            }
        ...
        /// <summary>
        /// The GetHeadsetVelocity method is used to determine the current vel		ocity of the headset.
        /// </summary>
        /// <returns>A Vector3 containing the current velocity of the headset.</returns>
        public override Vector3 GetHeadsetVelocity()
        {
			//TODO: return headset velocity from Tag
            return Vector3.zero;
