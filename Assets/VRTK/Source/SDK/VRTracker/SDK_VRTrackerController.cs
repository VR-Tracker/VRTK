...
namespace VRTK
{
...
#endif
    {
        ...
        private VRTracker.Manager.VRT_Tag vrtrackerTagLeft;
        private VRTracker.Manager.VRT_Tag vrtrackerTagRight;
        ...
        public override void ProcessUpdate(VRTK_ControllerReference controllerReference, Dictionary<string, object> options)
        {
            ...
            else if (IsControllerRightHand(controller) && vrtrackerTagRight)
            {
                ...
                cachedRightController.transform.rotation = vrtrackerTagRight.trackedEndpoints[0].transform.rotation;
            }
